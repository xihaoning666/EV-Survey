...
(function (global) {
  ...
  // TfNSW Lake Macquarie On Demand service area (current published suburbs).
  const ONDEMAND = new Set(['Dudley','Whitebridge','Mount Hutton','Windale','Tingira Heights','Eleebana','Warners Bay','Bennetts Green','Gateshead','Charlestown','Belmont','Belmont North','Croudace Bay','Valentine','Floraville','Jewells','Redhead']);
